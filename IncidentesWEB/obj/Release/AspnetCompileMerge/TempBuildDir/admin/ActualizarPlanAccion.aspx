<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarPlanAccion.aspx.cs" Inherits="IncidentesWEB.admin.ActualizarPlanAccion" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                ...
                <h2>Actualizar Plan de Acción:</h2>
                <table>
                    <tbody>
                        <tr>
