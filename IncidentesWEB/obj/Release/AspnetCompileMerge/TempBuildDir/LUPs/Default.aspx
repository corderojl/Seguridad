<%@ Page Title="" Language="C#" MasterPageFile="~/LUPs/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="IncidentesWEB.LUPs.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admin_cph_content" runat="server">
    ...
    <div id="contenido" class="cms">
        ...
        <asp:Literal ID="ltlPendiente" runat="server"></asp:Literal>
    </div>
</asp:Content>
