<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarAuditoriaPop.aspx.cs" Inherits="IncidentesWEB.Auditoria.ActualizarAuditoriaPop" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td width="300" align="right">
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" Width="130px" OnClientClick="return confirm('¿Deseas Eliminar el registro?')" OnClick="btnEliminar_Click" />
