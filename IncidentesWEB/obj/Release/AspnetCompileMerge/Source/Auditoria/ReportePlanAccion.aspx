<%@ Page Title="" Language="C#" MasterPageFile="~/Auditoria/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ReportePlanAccion.aspx.cs" Inherits="IncidentesWEB.Auditoria.ReportePlanAccion" %>
        ...
        <div id="formulario" class="custom_form">
            ...
            <table style="width: 95%;">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnBuscar" runat="server" Text="Buscar" CssClass="botonB" OnClick="btnBuscar_Click" />
