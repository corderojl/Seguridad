<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TrianguloSeguridad.aspx.cs" Inherits="IncidentesWEB.admin.TrianguloSeguridad" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script runat="server">
    // The following variables are visible to all procedures 
    // within the <script> block.
        String ColorSup = "style='border-bottom: 90px solid red;'";
        String ColorMed = "border-bottom: 100px solid #428bca;";
    String ColorBaj="border-bottom: 90px solid red;";
    String ColorBas="border-bottom: 90px solid red;";
...
<asp:Content ID="Content2" ContentPlaceHolderID="admin_cph_content" runat="server">
    <div id="contenido" class="cms">
        <div id="formulario" class="custom_form">
            ...
            <table style="width: 95%;">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnBuscar" runat="server" Text="   Consultar " CssClass="botonB" OnClick="btnBuscar_Click" />
                    </td>
                </tr>
            </table>
        </div>
        <div id="tabla">
            ...
            <asp:Literal ID="ltlTriangulo" runat="server"></asp:Literal>
