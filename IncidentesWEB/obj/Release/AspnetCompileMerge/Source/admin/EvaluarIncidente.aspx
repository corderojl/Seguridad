<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EvaluarIncidente.aspx.cs" Inherits="IncidentesWEB.admin.EvaluarIncidente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="css/style_control.css" rel="stylesheet" />
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="180">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="ddlDepartamento" InitialValue="0" Font-Size="Large"></asp:RequiredFieldValidator>
                            </td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="ddlRol" InitialValue="0" Font-Size="Large"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="ddlParteCuerpo" InitialValue="0" Font-Size="Large"></asp:RequiredFieldValidator>
                    </td>
                    <td align="right">Equipo afectado:</td>
                    <td>
                        <asp:DropDownList ID="ddlEquipoAfectado" runat="server" CssClass="form_row">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="ddlEquipoAfectado" InitialValue="0" Font-Size="Large"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
