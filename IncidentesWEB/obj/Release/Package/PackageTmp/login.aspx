<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="IncidentesWEB.login" %>
            ...
            <div id="footer_copy">
                <div class="copy">
                    <span class="left">Copyright 2017. All rights reserved.</span> <span class="derecha">
                        Powered by <a href="mailto:chefo@gmail.com">José Urco</a></span>
                </div>
            </div>
        </div>
    </div>
