<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="IncidentesWEB.LUPs.Login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Mondelez::Control de Defectos</title>
    ...
    <div id="admin_container">
        <div id="header">
            ...
            <div id="top_tips">
                <div id="tips">
                    <ul id="lista_tips">
                        <li><span>Administración de LUPs</span></li>
                    </ul>
                    <ul id="lista_tips_Izq">
                       <li>
                                <%if (Session["FUNCIONARIO_ID"] != null)  
                                      {
                                     %>
                                <a href="registrarsop.aspx">Registrar Nuevo</a>&nbsp;&nbsp;
                                <% 
                                  }  
                                  else{
                                  %>
                                ...
                                <%} %>
                                <a href="reportesop.aspx">Reporte</a>&nbsp;&nbsp;
                                <!--<a href="reporteoperadores.aspx">Rep. x Operador</a>&nbsp;&nbsp;-->
                                <% //if (Session["nombre"] != null) { Response.Write("Bienvenido " + Session["nombre"]); } %>
        ...
        <div id="footer">
            <div id="footer_copy">
                <div class="copy">
                    <span class="left">Copyright 2013. Mondelez. All rights reserved.</span> <span class="derecha">
                        Powered by <a href="#" target="_blank">JUrco</a></span>
                </div>
            </div>
        </div>
    </div>
