<%@ Page Title="" Language="C#" MasterPageFile="~/Alerta/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ActualizarAlerta.aspx.cs" Inherits="IncidentesWEB.Alerta.ActualizarAlerta" %>
        ...
        <div id="panel" class="custom_form">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <input type="button" value="Nuevo" name="Nuevo" onclick="window.location = 'registrarAlerta.aspx'" />
