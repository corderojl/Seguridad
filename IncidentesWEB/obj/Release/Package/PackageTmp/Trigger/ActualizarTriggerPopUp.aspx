<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarTriggerPopUp.aspx.cs" Inherits="IncidentesWEB.Trigger.ActualizarTriggerPopUp" %>
                        ...
                        <table class="tableTrigger">
                            ...
                            <tr>
                                ...
                                <td width="60%">
                                    ...
                                    <asp:RadioButtonList ID="rblTipoPersonal1" runat="server" Enabled="False" RepeatDirection="Horizontal">
                            ...
                            <tr>
                                ...
                                <td width="60%">
                                    ...
                                    <asp:RadioButtonList ID="rblTipoPersonal2" runat="server" Enabled="False" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="True" Value="1">P&amp;G</asp:ListItem>
                                        <asp:ListItem Value="2">Contratista</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtComp_crit_dia" runat="server" Height="30px" Width="90%" TextMode="MultiLine" AutoPostBack="True" OnTextChanged="txtComp_crit_dia_TextChanged"></asp:TextBox>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td width="300" align="right">
                        ...
                        <input name="button" type="button" onclick="ActualizoExito(); cerrarYActualizar();" value="Cerrar" style="width: 130px" /></td>
                    </td>
                </tr>
            </table>
