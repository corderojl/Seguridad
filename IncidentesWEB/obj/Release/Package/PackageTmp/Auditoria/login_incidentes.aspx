<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_incidentes.aspx.cs" Inherits="defectosView.auditoria.controldefectos.login_defectos" %>
    ...
    <div id="admin_container">
        <div id="header">
            ...
            <div id="top_tips">
                <div id="tips">
                    <ul id="lista_tips">
                        <li><span>Sistema de Auditoria</span></li>
                    </ul>
