<%@ Page Title="" Language="C#" MasterPageFile="~/Auditoria/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ReporteAuditoria.aspx.cs" Inherits="IncidentesWEB.Auditoria.ReporteAuditoria" %>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlAuditoria" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td>Auditor:</td>
                            <td>
