...
namespace IncidentesWEB.Auditoria
{
    public partial class ReportePlanAccion : System.Web.UI.Page
    {
            ...
            , string _Estado, DateTime _Fecha_incidente, DateTime _Fecha_incidente1)
        {
            ...
            DataTable Resultados = _TB_PlanAccionBL.ListarTB_PlanAccionFind_AUD(_Departamento_id, _tipoPlan, _Responsable, _Estado, _Fecha_incidente, _Fecha_incidente1);
            ...
            for (int i = 0; i < TotalRegistros; i++)
            {
                ...
                Tabla.Append("<td>" + Resultados.Rows[i]["Auditoria_Desc"] + "</td>");
