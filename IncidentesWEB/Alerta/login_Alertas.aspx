<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_Alertas.aspx.cs" Inherits="IncidentesWEB.Alerta.login_Alertas" %>
    ...
    <div id="admin_container">
        <div id="header">
            ...
            <div id="top_tips">
                <div id="tips">
                    <ul id="lista_tips">
                        <li><span>Sistema de Alertas de Calidad</span></li>
                    </ul>
