<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReporteEvaluacionAll.aspx.cs" Inherits="IncidentesWEB.Indicadores.frmReporteEvaluacionAll" %>
        ...
        <div>
            ...
            <div id="contenido" class="cms">
                <div id="panel" class="custom_form">
                    ...
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" Width="700px">
                    </rsweb:ReportViewer>
                </div>
            </div>
        </div>
