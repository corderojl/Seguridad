...
namespace IncidentesWEB.admin
{
    public partial class ReportePlanAccion : System.Web.UI.Page
    {
            ...
            , string _Estado, DateTime _Fecha_incidente, DateTime _Fecha_incidente1)
        {
            ...
            DataTable Resultados = _TB_PlanAccionBL.ListarTB_PlanAccionFind(_Departamento_id, _tipoPlan, _Responsable, _Estado, _Fecha_incidente, _Fecha_incidente1);
            ...
            string cabecera = "";
            cabecera = "<th>COD.</th><th width=\"210\"> DESCRIPCIÓN DEL PLAN </th><th width=\"150\"> TITULO DEL INCIDENTE. </th><th>FECHA</th><th> RESPONSABLE </th><th> DEPARTAMENTO. </th><th>TIP. PLAN.</th><th>ESTADO</th>";
            ...
            for (int i = 0; i < TotalRegistros; i++)
            {
                ...
                Tabla.AppendLine("<tr>");
                        ...
                        Tabla.Append("<td><a href=\"#\" onClick=\"PopUp('ActualizarPlanAccion.aspx?PlanAccion_id=" + _idEtiqueta + "',20,20,950,700); return false;\"> " + Resultados.Rows[i]["PlanAccion_desc"] + " </a></td>");
                //Tabla.Append("<td>" + Resultados.Rows[i]["Descripcion"] + "</td>");
                Tabla.Append("<td>" + Resultados.Rows[i]["Titulo"] + "</td>");
        ...
        {
            DataView dvDefectos;
            dvDefectos = new DataView(_TB_PlanAccionBL.ListarTB_PlanAccionFind_XLS(_Departamento_id, _tipoPlan, _Responsable
                , _Estado, _Fecha_incidente, _Fecha_incidente1));
            if (dvDefectos.Table.Rows.Count > 0)
            {
                try
                {
                    string filename = "Reporte Planes de Accion.xls";
